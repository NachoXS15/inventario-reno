-- ============================================================
-- MIGRACIÓN: soporte de cantidad en items y egresos
-- Ejecutar en el SQL Editor de Supabase
-- ============================================================

-- 1. Agregar columna cantidad_total a items
ALTER TABLE items ADD COLUMN IF NOT EXISTS cantidad_total integer;

-- 2. Agregar columna cantidad a egresos (default 1 para registros existentes)
ALTER TABLE egresos ADD COLUMN IF NOT EXISTS cantidad integer NOT NULL DEFAULT 1;

-- ============================================================
-- SEED: Productos del inventario de Mantenimiento
-- ============================================================

INSERT INTO items (nombre, categoria, descripcion, estado, ubicacion, prestado, team, cantidad_total)
VALUES
  -- Equipamiento
  ...
  -- Herramientas
  ('Soplete',                         'Herramientas',  'Soplete de gas para trabajos de plomería',                       'disponible', 'oficina_principal', false, 'mantenimiento', null),
  ...
  ('Cajas capsuladas exteriores',     'Eléctrico',     'Cajas capsuladas para instalaciones eléctricas exterior estanco','disponible', 'oficina_principal', false, 'mantenimiento', 5),
