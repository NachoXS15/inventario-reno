...
export function Header({ activeTeam }: { activeTeam: 'comunicacion' | 'mantenimiento' }) {
  const label = INVENTORY_LABELS[activeTeam]
  return (
    <header className="border-b border-zinc-200 bg-[#912ac8] px-4 py-3 sm:px-6 sm:py-4">
      <div className="mx-auto flex max-w-5xl items-center justify-between">
        <div className="min-w-0">
          <h1 className="text-xl font-semibold text-white sm:text-2xl">Inventario — {label}</h1>
